...
namespace Application.Core
{
  public class MappingProfiles : AutoMapper.Profile
  {
    ...
    {
      // `currentUsername` is passed in at runtime from the calling code (e.g., via AutoMapper's ProjectTo).
      // It helps determine if the current user is following someone.
